...
pOrder <- ggplot(orderDF, aes(x = FirstTask, y = meanScore, fill = context))+
  ...
  xlab('')+
  ylab('Mean Reward ±SE')+
  geom_signif(y_position = c(88, 100),  xmin = c(0.8,1.2), xmax = c(1.8,2.2), annotation = c("BF=0.67","BF=6.4"))+
...
```{r fig.width = 12, fig.height = 4}
trajectoryPlots <- cowplot::plot_grid(trajectoryplot, pTrajLengthReward, p6,  ncol=3, labels="auto")
trajectoryPlots
